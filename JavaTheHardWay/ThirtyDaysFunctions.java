...
/**
* Contains functions that make it easier to work with month
*/
public class ThirtyDaysFunctions {
  public static void main(String[] args) {
    ...
    *       the English name of the month, or "error" if out of range
    */
    ...
    *month the month number (1-12)
    * the number of days in a month, or 31 if out of range
    */
